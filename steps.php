            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> One Week Steps
...
Morris.Bar({
  element: 'graph1',
  data: [
    {x: '<?php echo $data_step['24']['dateTime']; ?>', y: <?php echo $data_step['24']['value']; ?>},
    {x: '<?php echo $data_step['25']['dateTime']; ?>', y: <?php echo $data_step['25']['value']; ?>},
    {x: '<?php echo $data_step['26']['dateTime']; ?>', y: <?php echo $data_step['26']['value']; ?>},
    {x: '<?php echo $data_step['27']['dateTime']; ?>', y: <?php echo $data_step['27']['value']; ?>},
    {x: '<?php echo $data_step['28']['dateTime']; ?>', y: <?php echo $data_step['28']['value']; ?>},
    {x: '<?php echo $data_step['29']['dateTime']; ?>', y: <?php echo $data_step['29']['value']; ?>},
    {x: '<?php echo $data_step['30']['dateTime']; ?>', y: <?php echo $data_step['30']['value']; ?>},
  ],
  xkey: 'x',
  ykeys: ['y'],
  labels: ['Steps']
