            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-green">
                        ...
                        <form role="form" class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
                            ...
                            <h5 class="text-danger"> <?php  echo $_SESSION["adminemail"];?> </h5>
                ...
                <div class="col-lg-4">
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <i class="fa fa-circle-o"></i> Fitbit Info
                        </div>
                        <div class="panel-body">
                            <h4><i class="fa fa-user"></i> User ID: </h4>
                            <h5 class="text-danger"> 277XTV </h5>
                        </div>
                        <div class="panel-footer">
                        </div>
                    </div>
