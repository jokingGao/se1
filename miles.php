            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> One Week Miles
...
Morris.Bar({
  element: 'graph3',
  data: [
    {x: '<?php echo $data_distance['24']['dateTime']; ?>', y: <?php echo $data_distance['24']['value']; ?>},
    {x: '<?php echo $data_distance['25']['dateTime']; ?>', y: <?php echo $data_distance['25']['value']; ?>},
    {x: '<?php echo $data_distance['26']['dateTime']; ?>', y: <?php echo $data_distance['26']['value']; ?>},
    {x: '<?php echo $data_distance['27']['dateTime']; ?>', y: <?php echo $data_distance['27']['value']; ?>},
    {x: '<?php echo $data_distance['28']['dateTime']; ?>', y: <?php echo $data_distance['28']['value']; ?>},
    {x: '<?php echo $data_distance['29']['dateTime']; ?>', y: <?php echo $data_distance['29']['value']; ?>},
    {x: '<?php echo $data_distance['30']['dateTime']; ?>', y: <?php echo $data_distance['30']['value']; ?>},
  ],
  xkey: 'x',
  ykeys: ['y'],
  labels: ['Distance']
